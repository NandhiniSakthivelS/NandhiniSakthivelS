...
<!--
**NandhiniSakthivelS/NandhiniSakthivelS** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
🌱 Spring Boot | ⚛️ React | ⚡ Vite | 🎨 Tailwind CSS

🗄️ Databases  
🐬 MySQL | 🍃 MongoDB

🔐 Backend & APIs  
🔗 REST API | 🔑 JWT | 🛡️ Spring Security
